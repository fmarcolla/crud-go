...
func (m *MockUserDomainService) UserLoginService(arg0 model.UserDomainInterface) (model.UserDomainInterface, string, *rest_err.RestErr) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "UserLoginService", arg0)
	ret0, _ := ret[0].(model.UserDomainInterface)
	ret1, _ := ret[1].(string)
...
func (mr *MockUserDomainServiceMockRecorder) UserLoginService(arg0 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UserLoginService", reflect.TypeOf((*MockUserDomainService)(nil).UserLoginService), arg0)
}
